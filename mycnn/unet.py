...
class UNet(KerasModel):
    ...
    def build(self):
        ...
        skip_list.append(CroppedFeatureMap(392,392, name=block_name+"_crop")(conv3x3))
        ...
        conv3x3 = layers.ReLU(name=block_name+"_relu2")(conv3x3)
        pool2x2 = layers.MaxPooling2D(pool_size=down_pool_size, name=block_name+"_pool")(conv3x3)
        skip_list.append(CroppedFeatureMap(200,200, name=block_name+"_crop")(conv3x3))
        ...
        conv3x3 = layers.ReLU(name=block_name+"_relu2")(conv3x3)
        pool2x2 = layers.MaxPooling2D(pool_size=down_pool_size, name=block_name+"_pool")(conv3x3)
        skip_list.append(CroppedFeatureMap(104,104, name=block_name+"_crop")(conv3x3))
        ...
        conv3x3 = layers.ReLU(name=block_name+"_relu2")(conv3x3)
        pool2x2 = layers.MaxPooling2D(pool_size=down_pool_size, name=block_name+"_pool")(conv3x3)
        skip_list.append(CroppedFeatureMap(56,56, name=block_name+"_crop")(conv3x3))
        ...
        block_name = "decoder4"
        filters = 512
        conv3x3 = layers.Conv2DTranspose(filters, up_sample_size, strides=up_sample_size, name=block_name+"_convt")(conv3x3)
